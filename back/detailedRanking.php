...
$maxMatchID = 60; // all the group matches

// get all the match info
$query = "SELECT match_id, left_team, right_team, match_time, result FROM matches WHERE match_id >= 57 AND match_id <= $maxMatchID ";
